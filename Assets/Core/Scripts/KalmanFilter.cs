...
public class KalmanFilter : MonoBehaviour
{
	...
	public const float DEFAULT_Q = 0.0001f;
	...
	public Vector3 UpdateFilter(Vector3 measurement, float? newQ = null, float? newR = null)
	{
	...
	public Vector3 UpdateFilter(List<Vector3> measurements, bool areMeasurementsNewestFirst = false, float? newQ = null, float? newR = null)
	{
		...
		while (i < measurements.Count && i >= 0)
		{
			...
			result = UpdateFilter(measurements[i], newQ, newR);
		}
